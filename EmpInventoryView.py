...
for i in data:
    empid = i[1]
    print("""
                    <a href="./EmpDashboard.py?id=%s"><i class="fa-solid fa-circle-user pe-1" style="color: white;"></i>%s</a>
                </div>""" % (i[0], i[2]))
                ...
                <ul class="nav-panel-ul">
                    ...
                    <div class="collapse" id="empdrop">
                        <ul>
                            ...
                            <li class="mt-2"><a class="px-5" href="./EmpInventoryView.py?id=%s">View</a></li>""" % (i[0], i[0]))
upid = empid
dbconn.commit()
dbconn.close()
print("""
...
q = """ select * from Emp_Inventory where uploadBy = '%s' """ % upid
curs.execute(q)
viddetails = curs.fetchall()
...
for i in viddetails:
    ...
    print("""
                                <tr class="h-70px">
                                    ...
                                    <td>%s</td>
                                    <td>%s</td>
                                </tr>""" % (vsno, vid, vname, vtitle, vchapter, vupdate, vsrc, vdesc, vtask, vnotes,'waiting' if vstatus == "None" else vstatus , vcomments))
print("""                                
                            </tbody>
                        </table>
                    </div>
